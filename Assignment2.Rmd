...
The dataset analyzed in this assignment contains 1000 observations on self-reported bribes in India from 12th to 30th of October 2015. Data is scraped from the webpage http://www.ipaidabribe.com/.
...
Data shows clearly that in the observed period some provinces experience more corruption than others. Karnataka is without comparison the city with most bribes reported. This cannot be explained by the size of the population, as Karnataka is only the ninth largest state in terms of population. For instance Uttar Pradesh and Maharashtra have more than three times larger populations than Karnataka[^states-india].
